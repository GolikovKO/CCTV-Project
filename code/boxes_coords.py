...
def locating_inside_stop(stop_id, time, boxes_coords, stop_points):
    ...
    for i in range(len(boxes_coords)):
        ...
        ((boxes_coords[i][4] <= stop_points.getX1() and boxes_coords[i][4] <= stop_points.getX2() and
          boxes_coords[i][4] <= stop_points.getX3() and boxes_coords[i][4] >= stop_points.getX4() and
          boxes_coords[i][5] >= stop_points.getY1() and boxes_coords[i][5] >= stop_points.getY2() and
          boxes_coords[i][5] <= stop_points.getY3() and boxes_coords[i][5] <= stop_points.getY4())
         or
         (boxes_coords[i][4] >= stop_points.getX1() and boxes_coords[i][4] <= stop_points.getX2() and
          boxes_coords[i][4] >= stop_points.getX3() and boxes_coords[i][4] >= stop_points.getX4() and
          boxes_coords[i][5] >= stop_points.getY1() and boxes_coords[i][5] >= stop_points.getY2() and
        ...
        ((boxes_coords[i][6] <= stop_points.getX1() and boxes_coords[i][6] <= stop_points.getX2() and
          boxes_coords[i][6] <= stop_points.getX3() and boxes_coords[i][6] >= stop_points.getX4() and
          boxes_coords[i][7] >= stop_points.getY1() and boxes_coords[i][7] >= stop_points.getY2() and
          boxes_coords[i][7] <= stop_points.getY3() and boxes_coords[i][7] <= stop_points.getY4())
         or
         (boxes_coords[i][6] >= stop_points.getX1() and boxes_coords[i][6] <= stop_points.getX2() and
          boxes_coords[i][6] >= stop_points.getX3() and boxes_coords[i][6] >= stop_points.getX4() and
          boxes_coords[i][7] >= stop_points.getY1() and boxes_coords[i][7] >= stop_points.getY2() and
